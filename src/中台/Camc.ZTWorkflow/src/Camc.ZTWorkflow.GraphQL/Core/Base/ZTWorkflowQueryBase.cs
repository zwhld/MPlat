...
namespace Camc.ZTWorkflow.Core.Base
{
    public abstract class ZTWorkflowQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected ZTWorkflowQueryBase(string fieldName,
