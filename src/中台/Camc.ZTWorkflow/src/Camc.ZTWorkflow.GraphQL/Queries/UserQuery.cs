...
using Camc.ZTWorkflow.Authorization.Roles;
using Camc.ZTWorkflow.Authorization.Users;
using Camc.ZTWorkflow.Core.Base;
using Camc.ZTWorkflow.Dto;
using Camc.ZTWorkflow.Types;
using Camc.ZTWorkflow.Core.Extensions;

namespace Camc.ZTWorkflow.Queries
{
    public class UserQuery : ZTWorkflowQueryBase<UserPagedResultGraphType, PagedResultDto<UserDto>>
    {
