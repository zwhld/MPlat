...
namespace Camc.ZTWorkflow.Web.Authentication.JwtBearer
{
    public class ZTWorkflowJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public ZTWorkflowJwtSecurityTokenHandler()
        {
