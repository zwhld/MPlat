...
{
    [DependsOn(
        typeof(ZTWorkflowWebCoreModule)
    )]
    public class ZTWorkflowWebHostModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ZTWorkflowWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ZTWorkflowWebHostModule).GetAssembly());
        }
