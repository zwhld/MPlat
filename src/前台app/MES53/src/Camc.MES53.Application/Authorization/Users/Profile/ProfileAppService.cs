...
using Camc.MES53.Authentication.TwoFactor.Google;
using Camc.MES53.Authorization.Users.Dto;
using Camc.MES53.Authorization.Users.Profile.Cache;
using Camc.MES53.Authorization.Users.Profile.Dto;
using Camc.MES53.Friendships;
using Camc.MES53.Gdpr;
using Camc.MES53.Identity;
using Camc.MES53.Security;
using Camc.MES53.Storage;
using Camc.MES53.Timing;

namespace Camc.MES53.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : MES53AppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Camc.MES53",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("Camc.MES53",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
