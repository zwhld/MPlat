...
using Camc.MES53.Migrations.Seed.Host;
...
namespace Camc.MES53.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : MES53AppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<MES53DbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(MES53Consts.ConnectionStringName).Value.ToString();
        }
