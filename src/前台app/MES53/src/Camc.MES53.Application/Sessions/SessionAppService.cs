...
{
    public class SessionAppService : MES53AppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = MES53Consts.Currency,
                    CurrencySign = MES53Consts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = MES53Consts.AllowTenantsToChangeEmailSettings
                }
            };
