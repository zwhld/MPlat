...
using Camc.MES53.Tenants.Dashboard.Dto;

namespace Camc.MES53.Tenants.Dashboard
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Tenant_Dashboard)]
    public class TenantDashboardAppService : MES53AppServiceBase, ITenantDashboardAppService
    {
