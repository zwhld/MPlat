...
namespace Camc.MES53.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : MES53ServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Camc.MES53", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
