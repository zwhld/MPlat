...
{
    public class MES53DbContext : AbpZeroDbContext<Tenant, Role, User, MES53DbContext>, IAbpPersistedGrantDbContext
    {
        ...
        public MES53DbContext(DbContextOptions<MES53DbContext> options)
            : base(options)
        {
