...
using MvvmHelpers;
using Camc.MES53.Authorization.Users.Profile;
using Camc.MES53.Authorization.Users.Profile.Dto;
using Camc.MES53.Commands;
...
using Camc.MES53.Controls;
using Camc.MES53.Dto;
using Camc.MES53.Extensions;
using Camc.MES53.Localization;
using Camc.MES53.UI;
using Camc.MES53.UI.Assets;
using Camc.MES53.Views;
using DependencyResolver = Camc.MES53.Core.Dependency.DependencyResolver;
...
namespace Camc.MES53.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "MES53";
