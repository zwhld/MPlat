...
using Camc.MES53.Web.Authentication.TwoFactor;
using Camc.MES53.Web.Chat.SignalR;
using Camc.MES53.Web.Configuration;
...
namespace Camc.MES53.Web
{
    ...
    public class MES53WebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public MES53WebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(MES53ApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MES53WebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(MES53WebCoreModule).GetAssembly().GetDirectoryPathOrNull();
