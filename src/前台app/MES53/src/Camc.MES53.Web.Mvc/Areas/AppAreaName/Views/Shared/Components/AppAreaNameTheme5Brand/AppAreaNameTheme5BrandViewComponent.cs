...
namespace Camc.MES53.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTheme5Brand
{
    public class AppAreaNameTheme5BrandViewComponent : MES53ViewComponent
    {
