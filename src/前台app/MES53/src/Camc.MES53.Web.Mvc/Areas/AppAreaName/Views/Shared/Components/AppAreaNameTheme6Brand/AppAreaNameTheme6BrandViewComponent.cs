...
namespace Camc.MES53.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameTheme6Brand
{
    public class AppAreaNameTheme6BrandViewComponent : MES53ViewComponent
    {
