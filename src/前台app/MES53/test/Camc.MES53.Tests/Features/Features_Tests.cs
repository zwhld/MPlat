...
using Camc.MES53.Features;
using Camc.MES53.Test.Base;
using Shouldly;
using Xunit;

namespace Camc.MES53.Tests.Features
{
    ...
    public class Features_Tests : AppTestBase
    {
        ...
        public async Task Should_Not_Create_User_More_Than_Allowed_Count()
        {
            ...
            exception.Message.ShouldContain(_localizationManager.GetString(MES53Consts.LocalizationSourceName, "MaximumUserCount_Error_Message"));
        }
    }
}
