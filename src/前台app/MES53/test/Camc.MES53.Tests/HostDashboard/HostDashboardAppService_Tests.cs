...
using Camc.MES53.MultiTenancy.HostDashboard;
...
namespace Camc.MES53.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(MES53DbContext context, SubscriptionPayment subscriptionPayment)
        {
